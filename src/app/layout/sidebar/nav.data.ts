...
export const NAV_SECTIONS: NavSection[] = [
    ...
    items: [
      {
        ...
        routerLink: ['/', APP_ROUTES.results.path],
      ...
      {
        label: 'Indicadores',
        routerLink: ['/', APP_ROUTES.indicators.path],
      ...
      },
      {
        ...
        routerLink: ['/', APP_ROUTES.sectors.path],
  ...
  },
  {
    ...
    items: [
      {
        label: 'Auditorias 5S',
        routerLink: ['/', APP_ROUTES.quality.path],
    ...
    items: [
      {
        ...
        routerLink: ['/', APP_ROUTES.sstRegister.path],
      ...
      },
      {
        ...
        routerLink: ['/', APP_ROUTES.sstRegister.path, APP_ROUTES.sstStatus.path],
    ...
    items: [
      {
        ...
        routerLink: ['/', APP_ROUTES.managers.path],
    ...
    items: [
      {
        ...
        routerLink: ['/', APP_ROUTES.export.path],
